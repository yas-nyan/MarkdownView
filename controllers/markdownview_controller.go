...
//+kubebuilder:rbac:groups=view.vsix.wide.ad.jp,resources=markdownviews,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=view.vsix.wide.ad.jp,resources=markdownviews/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=view.vsix.wide.ad.jp,resources=markdownviews/finalizers,verbs=update
