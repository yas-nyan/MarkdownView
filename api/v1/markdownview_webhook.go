...
//+kubebuilder:webhook:path=/mutate-view-vsix-wide-ad-jp-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.vsix.wide.ad.jp,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-view-vsix-wide-ad-jp-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.vsix.wide.ad.jp,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview.kb.io,admissionReviewVersions=v1
